...
| [`remote-frame-design.md`](./remote-frame-design.md) | Live design doc for `<RemoteFrame>` v2+ — open questions for permissions / config / auth / batching / sessions / hydration beyond what's shipped today. Parked, not dead. |
