...
export { Children, Child, type ChildrenProps, type ChildProps } from "./slot.tsx"
export { ROOT, capturePartialContext, type PartialCtx } from "./partial-context.ts"
export type { ActivatorProps, DeferSpec } from "./partial-component.tsx"
export {
  PartialsClient,
  getCachedPartialIds,
  useActivate,
