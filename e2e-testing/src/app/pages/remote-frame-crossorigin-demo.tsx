      ...
      <>
        <header className="mb-4" data-testid="rfxd-header">
          ...
          <p className="mt-2 text-xs text-muted-foreground">
            ...
            components below; the framework fetches their Flight bytes from the{" "}
            <code>e2e-magento</code> dev server, rewrites module references to absolute URLs at the
            remote's origin, decodes, and stitches the result into this response. If you don't see
            content below, the <code>e2e-magento</code> dev server isn't running.
          </p>
        </header>
